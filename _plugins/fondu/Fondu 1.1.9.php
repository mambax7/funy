...
/***************************************************************************
Message affiché audessus ou au dessous des images il peut inclure des balises HTML
ils seront automatiquement centré donc pas besoin d'ajouter la balise center
Afecté une chaine vide pour ne pas afficher de légende
***************************************************************************/
...
/***************************************************************************
Mode de calcul de la taille des images
***************************************************************************/
$modeSize = 1; //0= taille predefinie  1=taille des images trouvées
...
***************************************************************************/
$timeBetweenSlides = 1000;    // Amount of time between each image(1000 = 1 second)
$fadingSpeed       = 10;  	 // Speed of fading	(Lower value = faster)
$currentOpacity    = 10;	   // Initial opacity
...
***************************************************************************/
if ($legendTop <>""){echo "<center>".$legendTop."</center>";}
echo $headerStyle;
echo $headerScript;
echo $headerArray;
if ($legendBotom <>""){echo "<center>".$legendBotom."</center>";}
/***************************************************************************/
